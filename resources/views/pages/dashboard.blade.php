            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex flex-col lg:flex-row lg:items-center gap-4">
                        <div class="mr-auto">
                            ...
                            <div class="text-slate-500 mt-1">Pantau pelayanan harian dan kesiapan MCU siswa.</div>
                        </div>
                ...
                <div class="col-span-12">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <a href="{{ route('kunjungan.index', ['tanggal' => now()->toDateString()]) }}" class="report-box zoom-in block">
                                <div class="box p-5">
                                    <div class="flex">
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <a href="{{ route('kunjungan.index') }}" class="report-box zoom-in block">
                                <div class="box p-5">
                                    <div class="flex">
                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <a href="{{ route('pemeriksaan.index', ['semester' => $semester_berjalan, 'tahun_ajaran' => $tahun_ajaran_berjalan]) }}"
                               class="report-box zoom-in block">
                                <div class="box p-5">
                                    <div class="flex">
                                        <i data-feather="check-square" class="report-box__icon text-success"></i>
                                        <div class="ml-auto">
                                            <div class="report-box__indicator bg-success tooltip" title="Cakupan MCU semester berjalan">
                                    ...
                                    <div class="text-base text-slate-500 mt-1">MCU Selesai</div>
                                </div>
                            </a>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    <div class="flex">
                                        ...
                                        <div class="ml-auto">
                                            <div class="report-box__indicator bg-danger tooltip" title="Siswa yang perlu dijadwalkan MCU">
                                                Prioritas
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-3xl font-medium leading-8 mt-6">{{ $belum_pemeriksaan_semester }}</div>
                                    <div class="text-base text-slate-500 mt-1">Belum MCU</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-span-12 lg:col-span-4 mt-4">
                    ...
                    <div class="intro-y box p-5 mt-5">
                        @foreach ($status_kunjungan as $item)
                            ...
                            <a href="{{ route('kunjungan.index', ['status' => $item['status']]) }}"
                ...
                <div class="col-span-12 mt-4">
                    <div class="intro-y flex items-center h-10">
                        ...
                        <a href="{{ route('kunjungan.index') }}" class="ml-auto text-primary text-sm">Lihat semua</a>
                    </div>
                            ...
                            <tbody>
                                @forelse ($kunjungan_terbaru as $item)
                                    <tr class="intro-x">
                                        <td>
                                            @if ($item->anggota)
                                                <a href="{{ route('anggota.show', $item->anggota) }}" class="font-medium text-primary whitespace-nowrap">{{ $item->anggota->nama }}</a>
                                            @else
                                                -
                                            @endif
                ...
                <div class="2xl:pl-6 grid grid-cols-12 gap-6">
                    <div class="col-span-12 md:col-span-6 2xl:col-span-12 mt-8">
                        <div class="intro-x flex items-center h-10">
                            <h2 class="text-lg font-medium truncate mr-5">Prioritas MCU</h2>
                                ...
                                @forelse ($mcu_belum_list as $siswa)
                                    <div class="flex items-center py-3">
                                        ...
                                        <div class="ml-3 min-w-0">
                                            <a href="{{ route('anggota.show', $siswa) }}" class="font-medium text-primary truncate block">{{ $siswa->nama }}</a>
                                            <div class="text-xs text-slate-500 truncate">{{ optional($siswa->jenjang)->nama ?? '-' }}{{ $siswa->kelas ? ' - ' . $siswa->kelas : '' }}</div>
                                        </div>
                                    </div>
                                @empty
                                    <div class="text-center text-slate-500 py-6">Semua siswa sudah MCU.</div>
                                @endforelse
                            </div>
                            <a href="{{ route('pemeriksaan.index', ['semester' => $semester_berjalan, 'tahun_ajaran' => $tahun_ajaran_berjalan]) }}"
                    ...
                    <div class="col-span-12 md:col-span-6 2xl:col-span-12 mt-3">
                        ...
                        <div class="intro-x box p-5 mt-5">
                            ...
                            <a href="{{ route('anggota.index') }}" class="btn btn-outline-secondary w-full justify-start mt-3">
